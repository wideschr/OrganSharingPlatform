        ...
        <div class="flex flex-col justify-center items-align  pt-10 pb-5 text-center bg-gray-50">
            <x-page-title>
                ...
                <x-slot name="introText">
                    On this page you get an overview of all the offers you have posted on the platform. This also contains the
                    offers that are expired. You can use the filters or search bar to find the offers you are looking for.
                </x-slot>
            </x-page-title>
