            ...
            <div class="flex pr-10">
                ...
                <div class="flex flex-col flex-grow">
                    ...
                    <div class="mb-5">
                        ...
                        >   
                            <option value=""></option>
                            @foreach ($properties['species'] as $type)
                                <option value="{{ $type }}" >{{ ucwords($type) }}</option>
                            @endforeach
                        </select>
                        @error('species')
                    ...
                    <div class="mb-5">
                        ...
                        >   
                            <option value=""></option>
                            @foreach ($properties['strain'] as $type)
                                <option value="{{ $type }}" >{{ ucwords($type) }}</option>
                            @endforeach
                        </select>
                        @error('strain')
                ...
                <div class="flex flex-col flex-grow pl-10">
                    ...
                    <div class="mb-5">
                        ...
                        >   
                            <option value=""></option>
                            @foreach ($properties['sex'] as $type)
                                <option value="{{ $type }}" >{{ ucwords($type) }}</option>
                            @endforeach
                        </select>
                        @error('sex')
                    ...
                    <div class="mb-5">
                        ...
                        >   
                            <option value=""></option>
                            @foreach ($properties['vital_status'] as $type)
                                <option value="{{ $type }}" >{{ ucwords($type) }}</option>
                            @endforeach
                        </select>
                        @error('vital_status')
                ...
                <div class="flex flex-col flex-grow pl-10">
                    ...
                    <div class="mb-5">
                        ...
                        >   
                            <option value=""></option>
                            @foreach ($properties['euthanasia_method'] as $type)
                                <option value="{{ $type }}" >{{ ucwords($type) }}</option>
                            @endforeach
                        </select>
